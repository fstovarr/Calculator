...
public class CalculatorParser extends Parser {
	...
	public static final int DIVIDE = 1, INTO = 2, MINUS = 3, PLUS = 4, WHITESPACE = 5, NUMBER = 6, SEPARATOR = 7;
	public static final int RULE_line = 0, RULE_expression = 1, RULE_first_op = 2, RULE_second_op = 3;

	private static String[] makeRuleNames() {
		return new String[] { "line", "expression", "first_op", "second_op" };
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] { null, "DIVIDE", "INTO", "MINUS", "PLUS", "WHITESPACE", "NUMBER", "SEPARATOR" };
	}
	...
	public static class LineContext extends ParserRuleContext {
		...
		public List<TerminalNode> WHITESPACE() {
			return getTokens(CalculatorParser.WHITESPACE);
		}
		...
		public List<TerminalNode> SEPARATOR() {
			return getTokens(CalculatorParser.SEPARATOR);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof CalculatorVisitor)
				return ((CalculatorVisitor<? extends T>) visitor).visitLine(this);
			else
			...
			enterOuterAlt(_localctx, 1);
			{
				...
				do {
					...
					_la = _input.LA(1);
						...
						&& ((1L << _la) & ((1L << MINUS) | (1L << PLUS) | (1L << WHITESPACE) | (1L << NUMBER))) != 0));
			}
	...
	public static class FirstOrderOpsContext extends ExpressionContext {
		...
		public FirstOrderOpsContext(ExpressionContext ctx) {
			copyFrom(ctx);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof CalculatorVisitor)
				return ((CalculatorVisitor<? extends T>) visitor).visitFirstOrderOps(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class SecondOrderOpsContext extends ExpressionContext {
		...
		public SecondOrderOpsContext(ExpressionContext ctx) {
			copyFrom(ctx);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof CalculatorVisitor)
				return ((CalculatorVisitor<? extends T>) visitor).visitSecondOrderOps(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class UnaryOpsContext extends ExpressionContext {
		...
		public TerminalNode WHITESPACE() {
			return getToken(CalculatorParser.WHITESPACE, 0);
		}
		...
		public UnaryOpsContext(ExpressionContext ctx) {
			copyFrom(ctx);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof CalculatorVisitor)
				return ((CalculatorVisitor<? extends T>) visitor).visitUnaryOps(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class First_opContext extends ParserRuleContext {
		public TerminalNode INTO() {
			return getToken(CalculatorParser.INTO, 0);
		}
		...
		@Override
		public int getRuleIndex() {
			return RULE_first_op;
		}

		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof CalculatorVisitor)
				return ((CalculatorVisitor<? extends T>) visitor).visitFirst_op(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class Second_opContext extends ParserRuleContext {
		...
		@Override
		public int getRuleIndex() {
			return RULE_second_op;
		}

		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof CalculatorVisitor)
				return ((CalculatorVisitor<? extends T>) visitor).visitSecond_op(this);
			else
				return visitor.visitChildren(this);
		}
	}
