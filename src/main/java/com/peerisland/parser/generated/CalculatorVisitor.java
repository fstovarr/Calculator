...
public interface CalculatorVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code FirstOrderOps} labeled alternative
	 * in {@link CalculatorParser#expression}.
	 * 
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	 ...
	 * {@link CalculatorParser#expression}.
	 * 
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by the {@code SecondOrderOps} labeled alternative
	 * in {@link CalculatorParser#expression}.
	 * 
	 * @param ctx the parse tree
	 * @return the visitor result
	...
	/**
	 * Visit a parse tree produced by the {@code UnaryOps} labeled alternative in
	 * {@link CalculatorParser#expression}.
	 * 
	 * @param ctx the parse tree
	 * @return the visitor result
